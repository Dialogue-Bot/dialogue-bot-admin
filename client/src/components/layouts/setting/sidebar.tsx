...
const Sidebar = () => {
  ...
  return (
    <div className='min-h-svh w-[52px] md:w-sidebar-setting flex-shrink-0 bg-neutral-100 fixed bottom-0 left-sidebar'>
          ...
          return (
            <li key={item.i18n}>
              ...
              >
                ...
                <span className='md:block hidden'>{t(item.i18n)}</span>
              </NavLink>
            </li>
          )
        })}
