export const article = {
  date: '2022-09-05',
  title: 'Xây dựng hệ thống thiết kế cho tương lai đa hành tinh',
  description:
    'Hầu hết các công ty đều cố gắng đi trước xu hướng khi nói đến thiết kế trực quan, nhưng đối với Planetaria, chúng tôi cần tạo ra một thương hiệu vẫn truyền cảm hứng cho chúng tôi trong 100 năm nữa khi nhân loại đã lan rộng ra toàn bộ hệ mặt trời của chúng ta.',
  author: 'Hoang Huy',
}
